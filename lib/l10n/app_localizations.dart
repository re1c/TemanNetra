...
abstract class AppLocalizations {
  ...
  /// Judul halaman detail bantuan
  ///
  /// In id, this message translates to:
  /// **'Detail Bantuan'**
  String get helpRequestDetailsTitle;
  ...
  /// Pengumuman suara ketika sedang menunggu relawan terhubung
  ///
  /// In id, this message translates to:
  ...
  /// Status tiket sedang menunggu relawan
  ///
  /// In id, this message translates to:
  /// **'Menunggu Relawan'**
  String get ticketStatusPending;

  /// Status tiket sedang dibantu oleh relawan
  ///
  /// In id, this message translates to:
  /// **'Sedang Dibantu'**
  String get ticketStatusClaimed;

  /// Status tiket sudah selesai
  ///
  /// In id, this message translates to:
  /// **'Selesai'**
  String get ticketStatusResolved;

  /// Pengumuman peringatan keamanan untuk tunanetra
  ///
  /// In id, this message translates to:
